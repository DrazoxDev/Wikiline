        ...
        <>
            ...
            <section className="flex flex-col items-center gap-8 md:gap-12 px-4 py-6">
                ...
                <div className="flex flex-col items-center text-center">
                    <h2 className="font-soustitre text-2xl sm:text-3xl md:text-4xl">Choix de la</h2>
                    <h2 className="text-[#21897E] font-titre text-5xl sm:text-6xl md:text-7xl lg:text-8xl">Difficultée</h2>
                </div>
